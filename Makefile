...
$(CV_EN).png: $(CV_EN).pdf
	magick $(CV_EN).pdf -density 200 -background white -alpha remove $(CV_EN).png

$(CV_FR).png: $(CV_FR).pdf
	magick $(CV_FR).pdf -density 200 -background white -alpha remove $(CV_FR).png
...
$(COV_LETTER_FR).png: $(COV_LETTER_FR).pdf
	magick $(COV_LETTER_FR).pdf -density 200 -background white -alpha remove $(COV_LETTER_FR).png
